...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await idk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await ydk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await wdk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await hdk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await sdk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await adk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await bdk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if eight:
        ...
        try:
            ...
            await cdk.start()
            await cdk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await cdk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await ddk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel="@X_User_Bot"))
            await edk(functions.channels.JoinChannelRequest(channel="@X_Discussion"))
...
Y88b   d88P       888888b.    .d88888b. 88888888888 
 Y88b d88P        888  "88b  d88P" "Y88b    888     
  Y88o88P         888  .88P  888     888    888     
   Y888P          8888888K.  888     888    888     
   d888b          888  "Y88b 888     888    888     
  d88888b  888888 888    888 888    888    888     
 d88P Y88b        888   d88P Y88b. .d88P    888     
d88P   Y88b       8888888P"   "Y88888P"     888     
...
print(text)
print("")
print("Nacho Re  X Multi Spam Bot Started Sucessfully.")
